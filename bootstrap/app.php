    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        switch ($environment) {
            case 'production':
                ...
                break;
            case 'staging':
                // Configuration for DigitalOcean or similar
            ...
            default:
                ...
                $middleware->trustProxies(at: ['127.0.0.1', '::1'], headers: Request::HEADER_X_FORWARDED_FOR | Request::HEADER_X_FORWARDED_PROTO);
        }
    })
